...
$conexao = $config->conectaBanco();
  ...
  if(checkValues($_POST['nome_completo'], $_POST['nickname'], $_POST['email'], $_POST['senha'])){
  ...
  function checkValues($nome_completo, $nickname, $email, $senha) {
    if(isset($nome_completo) && !empty($nome_completo) && isset($nickname) && !empty($nickname) && isset($email) && !empty($email) && isset($senha) && !empty($senha)){
      $ResultC = true; 
    }
    else {
      $ResultC = false;
