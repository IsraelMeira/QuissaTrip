      ...
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               ...
               <a href="../index_usuario.html" class="navbar-brand"><span>QuissaTrip</span></a>
            </div>
         </div>
      </div>
   </div>
                  ...
                  <div class="owl-carousel">
                     <div >
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-8 col-xxs-12">
                           <blockquote>
                              <h3 style="color:#656868;"><em><b>Nome:</b></em></h4>
                              <p><b><?php echo $nome?></b></p>
                              <h3 style="color:#656868;"><em><b>E-mail:</b></em></h4>
                              <p><b><?php echo $email?></b></p>
                              <center><a href="../page/role.php"><button style="background-color:#9933ff; "  class="btn btn-primary"> Rolê</button></p></a></center>
                           </blockquote>
                           <br>
                           <br>
                     ...
                     <div>
                        <div >
                           <center>
                              <H2 style="color:#656868;">Editar:</H2>
                           </center>
                        ...
                        <form enctype="multipart/form-data" action="../PHP/Upload_perfil_img.php" method="post">
                           <center>
                           	...
                           	<div><input style="background-color: #9933ff;" class="btn btn-primary" type="submit" value="Enviar"/></div>
                           </center>
                        </form>
                        <div class="col-md-9 col-sm-9 col-xs-8 col-xxs-12">
                           <blockquote>
